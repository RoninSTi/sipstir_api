const { validatePostAuthApple, validatePostAuthFacebook, validatePostLogin, validatePostRegister } = require('../validations/auth');
const { getAuthSwoopCallback, postAuthApple, postAuthFacebook, postLogin, postRegister } = require('../controllers/authController');
